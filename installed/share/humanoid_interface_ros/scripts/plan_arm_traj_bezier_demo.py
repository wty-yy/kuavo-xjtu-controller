...
def plan_arm_trajectory_bezier_curve_client(req):
    ...
    try:
        ...
        print(req.multi_joint_bezier_trajectory[3])
...
def Pre_to_catch_bag():
    traj_sub = rospy.Subscriber('/bezier/arm_traj', JointTrajectory, traj_callback)
    ...
    file_path = rospy.get_param('~tact_file', './action_files/Catch_bag2.tact')
